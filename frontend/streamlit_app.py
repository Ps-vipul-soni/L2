...
* **4. Supplier Risk**: Graph-based supplier risk analytics and multi-tier violation tracing.
* **5. Compliance Reports**: Access generated PDF/Markdown executive summaries and compliance certificates.
* **6. Review Queue**: Human-in-the-loop task queue for subjective rule judgments and low-confidence extractions.
* **7. Settings**: Configure regulatory thresholds, API keys, and notification preferences.
